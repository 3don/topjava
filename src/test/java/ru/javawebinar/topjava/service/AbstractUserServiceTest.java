...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    public void setup() {
        ...
        if (env.acceptsProfiles(org.springframework.core.env.Profiles.of(Profiles.DATAJPA,Profiles.JPA)))
    ...
    public void createWithException() throws Exception {
        Assume.assumeFalse(Arrays.stream(env.getActiveProfiles()).anyMatch(x -> x.equals(Profiles.JDBC)));
