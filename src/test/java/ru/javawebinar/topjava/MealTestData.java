...
public class MealTestData {
    ...
    public static Meal getNew() {
        return new Meal(null, LocalDateTime.of(2022, Month.APRIL, 1, 15, 10), "Новая еда", 1200);
    }

    public static Meal getUpdated() {
        Meal updated = new Meal(userMeal1);
        updated.setDateTime(LocalDateTime.of(2022, Month.APRIL, 2, 15, 20));
        updated.setDescription("updated Завтрак");
        updated.setCalories(502);
        return updated;
    }
